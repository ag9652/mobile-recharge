...
public class ExecuterMain {
	public static void main(String[] args) {
		...
		System.out.println("1: Registration For Customer");
					...
					while (true) {
						...
						if (customer != null) {
							...
							if (s.equals("y") || s.equals("Y")) {
								...
								System.out.println("Do you want to apply for the loan then press Y/y");
								s = sc.next();
								Loan loan = new Loan(Amount, custId, duration);
								if (s.equals("y") || s.equals("Y")) {

									loan = service.applyLoan(loan);
									long loanID = (long) (Math.random() * 123);
